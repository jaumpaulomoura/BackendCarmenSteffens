...
pesModelEnt = Blueprint('pesModelEnt', __name__)
...
@pesModelEnt.route('/api/queryEnt', methods=['GET'])
...
@pesModelEnt.route('/api/exportEnt/excel', methods=['GET'])
def export_results_to_excelEnt():
    ...
    try:
        ...
        # Salvar a pasta de trabalho (workbook) no objeto BytesIO usando openpyxlX
